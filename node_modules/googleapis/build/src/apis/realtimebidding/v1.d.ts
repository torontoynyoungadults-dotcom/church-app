...
export declare namespace realtimebidding_v1 {
    ...
    export class Resource$Buyers$Creatives {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        addDeals(params: Params$Resource$Buyers$Creatives$Adddeals, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        addDeals(params?: Params$Resource$Buyers$Creatives$Adddeals, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Creative>>;
        addDeals(params: Params$Resource$Buyers$Creatives$Adddeals, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        addDeals(params: Params$Resource$Buyers$Creatives$Adddeals, options: MethodOptions | BodyResponseCallback<Schema$Creative>, callback: BodyResponseCallback<Schema$Creative>): void;
        addDeals(params: Params$Resource$Buyers$Creatives$Adddeals, callback: BodyResponseCallback<Schema$Creative>): void;
