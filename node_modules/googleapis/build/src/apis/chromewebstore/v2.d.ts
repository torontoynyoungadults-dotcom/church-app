...
export declare namespace chromewebstore_v2 {
    ...
    export class Resource$Publishers$Items {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchReviews(params: Params$Resource$Publishers$Items$Fetchreviews, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchReviews(params?: Params$Resource$Publishers$Items$Fetchreviews, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchItemReviewsResponse>>;
        fetchReviews(params: Params$Resource$Publishers$Items$Fetchreviews, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchReviews(params: Params$Resource$Publishers$Items$Fetchreviews, options: MethodOptions | BodyResponseCallback<Schema$FetchItemReviewsResponse>, callback: BodyResponseCallback<Schema$FetchItemReviewsResponse>): void;
        fetchReviews(params: Params$Resource$Publishers$Items$Fetchreviews, callback: BodyResponseCallback<Schema$FetchItemReviewsResponse>): void;
        fetchReviews(callback: BodyResponseCallback<Schema$FetchItemReviewsResponse>): void;
        /**
