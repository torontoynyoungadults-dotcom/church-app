...
export declare namespace meet_v2 {
    ...
    export class Resource$Spaces$Members {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchUpdate(params: Params$Resource$Spaces$Members$Batchupdate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        batchUpdate(params?: Params$Resource$Spaces$Members$Batchupdate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BatchUpdateMembersResponse>>;
        batchUpdate(params: Params$Resource$Spaces$Members$Batchupdate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        batchUpdate(params: Params$Resource$Spaces$Members$Batchupdate, options: MethodOptions | BodyResponseCallback<Schema$BatchUpdateMembersResponse>, callback: BodyResponseCallback<Schema$BatchUpdateMembersResponse>): void;
        batchUpdate(params: Params$Resource$Spaces$Members$Batchupdate, callback: BodyResponseCallback<Schema$BatchUpdateMembersResponse>): void;
        batchUpdate(callback: BodyResponseCallback<Schema$BatchUpdateMembersResponse>): void;
        /**
        ...
        create(params?: Params$Resource$Spaces$Members$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Member>>;
        ...
        create(params: Params$Resource$Spaces$Members$Create, options: MethodOptions | BodyResponseCallback<Schema$Member>, callback: BodyResponseCallback<Schema$Member>): void;
        create(params: Params$Resource$Spaces$Members$Create, callback: BodyResponseCallback<Schema$Member>): void;
        ...
        delete(params?: Params$Resource$Spaces$Members$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        ...
        delete(params: Params$Resource$Spaces$Members$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Spaces$Members$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
        ...
        get(params?: Params$Resource$Spaces$Members$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Member>>;
        ...
        get(params: Params$Resource$Spaces$Members$Get, options: MethodOptions | BodyResponseCallback<Schema$Member>, callback: BodyResponseCallback<Schema$Member>): void;
        get(params: Params$Resource$Spaces$Members$Get, callback: BodyResponseCallback<Schema$Member>): void;
        ...
        list(params?: Params$Resource$Spaces$Members$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListMembersResponse>>;
        ...
        list(params: Params$Resource$Spaces$Members$List, options: MethodOptions | BodyResponseCallback<Schema$ListMembersResponse>, callback: BodyResponseCallback<Schema$ListMembersResponse>): void;
        list(params: Params$Resource$Spaces$Members$List, callback: BodyResponseCallback<Schema$ListMembersResponse>): void;
        ...
        patch(params?: Params$Resource$Spaces$Members$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Member>>;
        ...
        patch(params: Params$Resource$Spaces$Members$Patch, options: MethodOptions | BodyResponseCallback<Schema$Member>, callback: BodyResponseCallback<Schema$Member>): void;
        patch(params: Params$Resource$Spaces$Members$Patch, callback: BodyResponseCallback<Schema$Member>): void;
