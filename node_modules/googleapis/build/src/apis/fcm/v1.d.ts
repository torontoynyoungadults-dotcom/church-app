...
export declare namespace fcm_v1 {
    ...
    export class Resource$Projects$Registrations$Topicsubscriptions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Registrations$Topicsubscriptions$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TopicSubscription>>;
        create(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Create, options: MethodOptions | BodyResponseCallback<Schema$TopicSubscription>, callback: BodyResponseCallback<Schema$TopicSubscription>): void;
        create(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Create, callback: BodyResponseCallback<Schema$TopicSubscription>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Registrations$Topicsubscriptions$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
        delete(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Delete, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        delete(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Delete, callback: BodyResponseCallback<Schema$Empty>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Registrations$Topicsubscriptions$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TopicSubscription>>;
        get(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Get, options: MethodOptions | BodyResponseCallback<Schema$TopicSubscription>, callback: BodyResponseCallback<Schema$TopicSubscription>): void;
        get(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Get, callback: BodyResponseCallback<Schema$TopicSubscription>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Registrations$Topicsubscriptions$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Registrations$Topicsubscriptions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListTopicSubscriptionsResponse>>;
        list(params: Params$Resource$Projects$Registrations$Topicsubscriptions$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Registrations$Topicsubscriptions$List, options: MethodOptions | BodyResponseCallback<Schema$ListTopicSubscriptionsResponse>, callback: BodyResponseCallback<Schema$ListTopicSubscriptionsResponse>): void;
        list(params: Params$Resource$Projects$Registrations$Topicsubscriptions$List, callback: BodyResponseCallback<Schema$ListTopicSubscriptionsResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Registrations$Topicsubscriptions$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$TopicSubscription>>;
        patch(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Patch, options: MethodOptions | BodyResponseCallback<Schema$TopicSubscription>, callback: BodyResponseCallback<Schema$TopicSubscription>): void;
        patch(params: Params$Resource$Projects$Registrations$Topicsubscriptions$Patch, callback: BodyResponseCallback<Schema$TopicSubscription>): void;
