...
export declare namespace agentidentitycredentials_v1alpha {
    ...
    export class Resource$Projects$Locations$Authproviders$Credentials {
         ...
         */
        exchange(params: Params$Resource$Projects$Locations$Authproviders$Credentials$Exchange, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        exchange(params?: Params$Resource$Projects$Locations$Authproviders$Credentials$Exchange, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudAgentidentitycredentialsV1alpha_ExchangeCredentialsResponse>>;
        exchange(params: Params$Resource$Projects$Locations$Authproviders$Credentials$Exchange, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        exchange(params: Params$Resource$Projects$Locations$Authproviders$Credentials$Exchange, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1alpha_ExchangeCredentialsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1alpha_ExchangeCredentialsResponse>): void;
        exchange(params: Params$Resource$Projects$Locations$Authproviders$Credentials$Exchange, callback: BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1alpha_ExchangeCredentialsResponse>): void;
        exchange(callback: BodyResponseCallback<Schema$GoogleCloudAgentidentitycredentialsV1alpha_ExchangeCredentialsResponse>): void;
        /**
