...
(function (marketingplatformadmin_v1alpha) {
    ...
    class Resource$Organizations {
        ...
        constructor(context) {
            ...
            this.adminAccessBindings = new Resource$Organizations$Adminaccessbindings(this.context);
    ...
    class Resource$Organizations$Adminaccessbindings {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1alpha/{+parent}/adminAccessBindings').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    marketingplatformadmin_v1alpha.Resource$Organizations$Adminaccessbindings = Resource$Organizations$Adminaccessbindings;
    ...
    class Resource$Organizations$Usergroups {
        context;
        members;
        constructor(context) {
            this.context = context;
            this.members = new Resource$Organizations$Usergroups$Members(this.context);
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1alpha/{+parent}/userGroups').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    marketingplatformadmin_v1alpha.Resource$Organizations$Usergroups = Resource$Organizations$Usergroups;
    class Resource$Organizations$Usergroups$Members {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1alpha/{+parent}/members').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    marketingplatformadmin_v1alpha.Resource$Organizations$Usergroups$Members = Resource$Organizations$Usergroups$Members;
